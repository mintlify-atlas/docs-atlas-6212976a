...
<ParamField path="password" type="string" default="paradox">
  IP module password used to decrypt the session. This is the same password configured in `IP_CONNECTION_PASSWORD`. The factory default is `paradox`.
</ParamField>
