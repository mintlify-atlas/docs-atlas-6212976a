...
The image exposes two ports, used only if the corresponding interfaces are enabled in your config:

| Port | Interface |
|---|---|
| `18839/tcp` | Internal MQTT broker (bind address `0.0.0.0`) |
| `10000/tcp` | IP Socket Interface (`IP_INTERFACE_ENABLE = True`) |
